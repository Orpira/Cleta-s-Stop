...
import { DEFAULT_STOP_SETTINGS } from '@/lib/games/stop/gameLogic';
...
export default function StopHome() {
  ...
  async function handleCreate() {
    ...
    setError('');
    try {
      const { room } = await createRoom(GAME_TYPE, nickname, DEFAULT_STOP_SETTINGS);
      router.push(`/juegos/stop/sala/${room.code}`);
    } catch (e: any) {
